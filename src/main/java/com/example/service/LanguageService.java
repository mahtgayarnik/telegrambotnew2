...
public class LanguageService {
    ...
    private Map<String, String> russianMap = new HashMap<String, String>() {{
        ...
        put("Сделайте добровольный взнос. Переведите 10 UAH участнику проекта на его карту 0000 0000 0000 0000. После перевода средств нажмите кнопку \"подтвердить перевод\". Если Вы нажали кнопку \"подтвердить перевод\", но не перевели средства, то в течении суток Ваш аккаунт будет удален!", "Сделайте добровольный взнос. Переведите 10 UAH участнику проекта на его карту 0000 0000 0000 0000. После перевода средств нажмите кнопку \"подтвердить перевод\". Если Вы нажали кнопку \"подтвердить перевод\", но не перевели средства, то в течении суток Ваш аккаунт будет удален!");
    ...
    private Map<String, String> englishMap = new HashMap<String, String>() {{
        ...
        put("Сделайте добровольный взнос. Переведите 10 UAH участнику проекта на его карту 0000 0000 0000 0000. После перевода средств нажмите кнопку \"подтвердить перевод\". Если Вы нажали кнопку \"подтвердить перевод\", но не перевели средства, то в течении суток Ваш аккаунт будет удален!", "Make a voluntary contribution. Transfer 10 UAH to the project participant on his card 0000 0000 0000 0000. After transferring funds, click the \"confirm transfer\" button. If you clicked on the \"confirm transfer\" button, but did not transfer funds, then your account will be deleted within 24 hours!");
