...
public class LanguageService {
    ...
    private Map<String, String> russianMap = new HashMap<String, String>() {{
        ...
        put("Попросить Админа подтвердить", "Попросить Админа подтвердить");
        put("Ваш заказ отправлен Администратору. После подтверждения Администратором получения денег Вы сможете приобрести Уровень.", "Ваш заказ отправлен Администратору. После подтверждения Администратором получения денег Вы сможете приобрести Уровень.");
        ...
        put("Сделайте добровольный взнос!", "Сделайте добровольный взнос!");
    ...
    private Map<String, String> englishMap = new HashMap<String, String>() {{
        ...
        put("Сделайте добровольный взнос.", "Make a voluntary contribution.");
        ...
        put("Попросить Админа подтвердить", "Ask admin confirm");
        put("Ваш заказ отправлен Администратору. После подтверждения Администратором получения денег Вы сможете приобрести Уровень.", "Your order has been sent to the Administrator. After the administrator confirms the receipt of money, you can purchase a Level.");
